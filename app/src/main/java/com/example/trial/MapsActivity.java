    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locList = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                mMap.addMarker(new MarkerOptions().position(curloc).title("My Location"));
                mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(curloc, 18));
            }
        ...
        else
        {
            ...
            mMap.clear();
            mMap.addMarker(new MarkerOptions().position(last).title("My Location"));
            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(last, 18));
        }
    }
}
